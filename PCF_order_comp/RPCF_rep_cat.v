...
Require Export CatSem.PCF_order_comp.RPCF_rep_comp.
Require Export CatSem.PCF_order_comp.RPCF_rep_id.
Require Export CatSem.PCF_order_comp.RPCF_rep_eq.
...
Next Obligation.
  ...
  simpl in *.
  assert (H4 :=H3 _ _ (id_retype(V:=V))t y ).
  simpl in H4.
  rewrite <- H4.
  clear H4.
