...
Inductive PCF2 (V: ipo) : TY -> Type:=
 | Bottom2: forall t, PCF2 V t
 | Const2 : forall t, Consts t -> PCF2 V t
 | Var2 : forall t, V t -> PCF2 V t
 | App2 : forall t s, PCF2 V (s ~> t) -> PCF2 V s -> PCF2 V t
 | Lam2 : forall t s, PCF2 (opt_TP t V) s -> PCF2 V (t ~> s)
 | Rec2 : forall t, PCF2 V (t ~> t) -> PCF2 V t.
...
Definition PCFrel := forall (V:ipo) t, relation (PCF V t).

Reserved Notation "x :> y" (at level 70).

Variable rel : forall (V:ipo) t, relation (PCF V t).

Inductive propag (V: ipo) 
...
Inductive beta_ (V:ipo): forall t, relation (PCF V t) :=
